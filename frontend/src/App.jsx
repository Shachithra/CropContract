...
const BuyerAlerts = lazy(() => import('./pages/buyer/BuyerAlerts.jsx'))
...
const OfficerReports = lazy(() => import('./pages/officer/OfficerReports.jsx'))
      ...
      <Routes>
        ...
        <Route element={<ProtectedLayout />}>
          ...
          <Route element={<RoleRoute roles={['buyer']} />}>
            ...
            <Route path="/buyer/alerts" element={<BuyerAlerts />} />
          </Route>
